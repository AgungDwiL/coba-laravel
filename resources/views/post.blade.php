...
<div class="container">
  <div class="row justify-content-center mb-5">
    <div class="col-md-8">
      ...
      <p>by: <a href="{{ url('posts?author=' . $post->author->name) }}" class="text-decoration-none">{{ $post->author->name }}</a> in <a href="{{ url('posts?category=' . $posts[0]->category->slug) }}">{{ $post->category->name }}</a></p>
